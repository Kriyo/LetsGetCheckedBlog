...
export const MOCK_SINGLE_POST_URL = 'http://localhost:3000/blog/1'

export const HOME_LOADING_STATE_CONTEXT_PROVIDER = {
  loading: true,
  posts: { blog: null, error: null },
}

export const HOME_ERROR_STATE_CONTEXT_PROVIDER = {
  loading: false,
  posts: { blog: null, error: 'There was an error retrieving data' },
}

export const HOME_WORKING_STATE_CONTEXT_PROVIDER = {
  loading: false,
  posts: SORTED_BLOG_DATA,
}
